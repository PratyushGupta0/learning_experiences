...
int main(int argc,char **argv){
    ...
    ROS_INFO_STREAM("Exited the buffer time.Ready to publish wavepoint");
    i=0;
    ...
    while(ros::ok()&&i<300){
        ...
        coordinates.pose.position.z=z_lab;
    ...
    while(ros::ok()){
        ...
        else  coordinates.pose.position.x=-x_lab;
        
        coordinates.header=header;
        coordinates.pose.position.y=0;
        coordinates.pose.position.z=2.8;
        // coordinates.pose.orientation.x=0;
        // coordinates.pose.orientation.y=0;
        // coordinates.pose.orientation.z=0;
        // coordinates.pose.orientation.w=1;
